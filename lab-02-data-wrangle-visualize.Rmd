---
title: "Lab 02 - You should Major in Engineering"
subtitle: "Data wrangling and visualization"
author: "NE and VW Team!"
output: 
  tufte::tufte_html:
...
```{marginfigure}
**A note on expectations: ** Do each exercise on your own and include any relevant output (tables, summary statistics, plots) in your 
...
In this lab we will work with the `tidyverse` and `fivethirtyeight` packages. We start by loading each package.
